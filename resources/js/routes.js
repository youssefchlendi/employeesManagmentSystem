...
import oneEntreprise from "./routes/oneEntreprise";
import Employe from "./routes/Employe";
import oneEmploye from "./routes/oneEmploye";
...
export default new VueRouter(
    {
        ...
        routes: [
            ...example,...Entreprise,...Employe,...Fiche,...Rebrique,...addEmploye,...Dashboard,...oneEntreprise,...oneEmploye
            ],
    }
)
